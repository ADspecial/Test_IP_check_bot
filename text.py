...
block_menu = "📍 Меню блокировки ip"
blocklist_menu = "📍 Меню управления блоклистами"
...
sechost_menu = "📍 Меню управления СЗИ"
sechost_view = "Введите количество дней за которое нужно вывести СЗИ или введите `all` для просмотра всех СЗИ"
group_sechost_menu = "📍 Меню управления группами СЗИ"
...
err_processing = "При обработке IP-адреса с помощью {service} возникла ошибка."
